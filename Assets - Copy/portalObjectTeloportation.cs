...
public class portalObjectTeloportation : MonoBehaviour
{
    ...
    {
        if (collision.gameObject.CompareTag("bullet") || collision.gameObject.CompareTag("bullet_Shotgun") || collision.gameObject.CompareTag("Bullet_Sniper") && portalDisabled == false)
        {
