...
public class aimingAnimationDisplay : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (playSO[playInput.playerIndex].rolling == false && playSO[playInput.playerIndex].lightingGoblin ==false && playSO[playInput.playerIndex].buff == false)
        {
            ...
            else if (playSO[playIndex].moveInput == Vector2.zero && playSO[playIndex].health > 0)
            {
                animManager.ChangeAnimationState(animManager.IDLE);
            }
        }else if (playSO[playInput.playerIndex].buff && playSO[playInput.playerIndex].canMove && playSO[playInput.playerIndex].firing == false)
        {
