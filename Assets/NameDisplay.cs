...
public class NameDisplay : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (PlayerPrefs.HasKey("LastNamePlayer" + playInput.playerIndex.ToString()))
        {
            nameDisplayText.text = PlayerPrefs.GetString("LastNamePlayer" + playInput.playerIndex.ToString());
        }
    }
